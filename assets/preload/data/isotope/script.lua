...
local yy2 = 440; -- Same code as above, but for boyfriend up, down
local xx3 = 500; -- Same code as above, but for girlfriend left, right
...
getProperty('boyfriend.animation.curAnim.name') == 'idle' then
            ...
            if
getProperty('boyfriend.animation.curAnim.name') == 'idle-alt' then
                triggerEvent('Camera Follow Pos',650,800)
            end
